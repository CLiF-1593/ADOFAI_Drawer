...
void Drawer::Drawing(int x, int y) {
	//Coordinate Check
...
ColorRGB Drawer::GetColor(int x, int y) {
	ColorRGB rgb(img.pixelColor(x, y));
	return rgb;
}

void Drawer::SetImageFile(string img_path) {
	this->img_path = img_path;
	this->data.clear();
}

void Drawer::DrawData() {
...
void Drawer::SaveData(string adofai_path, int position, string mode) {
...
void Drawer::Save(string adofai_path) {
	FILE *f;
